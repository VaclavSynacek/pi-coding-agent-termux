...
### 6. GitHub Workflows
- **Removed**: All GitHub Actions workflows (`.github/workflows/`)
- **Reason**: Building happens locally on development machines, not via CI/CD
- **Note**: The port requires building on a regular machine (not Termux) due to tsgo lacking ARM64 binaries
- **Files removed**: `.github/workflows/ci.yml`, `.github/workflows/build-binaries.yml`
